...
const checkall = document.querySelector('#check-set');
const check1 = document.querySelector('#check-in1');
const check2 = document.querySelector('#check-in2');
const check3 = document.querySelector('#check-in3');
const check4 = document.querySelector('#check-in4');
const check5 = document.querySelector('#check-in5');
